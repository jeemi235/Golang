...
type TodoResolver interface {
	Name(ctx context.Context, obj *model.Todo) (string, error)
}
...
func (ec *executionContext) _Query_todo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOTodo2ᚖbetterpgᚋgraphᚋmodelᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOTodo2ᚖbetterpgᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v *model.Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
