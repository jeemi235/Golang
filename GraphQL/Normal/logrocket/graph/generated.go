...
type ComplexityRoot struct {
	Mutation struct {
		...
		DeleteTodo func(childComplexity int, input model.Delete) int
...
type MutationResolver interface {
	...
	DeleteTodo(ctx context.Context, input model.Delete) (*model.Todo, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.deleteTodo":
		...
		return e.complexity.Mutation.DeleteTodo(childComplexity, args["input"].(model.Delete)), true
...
func (ec *executionContext) field_Mutation_deleteTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNdelete2logrocketᚋgraphᚋmodelᚐDelete(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_deleteTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteTodo(rctx, fc.Args["input"].(model.Delete))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalNdelete2logrocketᚋgraphᚋmodelᚐDelete(ctx context.Context, v interface{}) (model.Delete, error) {
